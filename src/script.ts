let card_back_player = document.querySelector(
  ".card-back-player"
) as HTMLElement;
let carta_jogador = document.querySelector(".carta-jogador") as HTMLElement;
let card_back_maquina = document.querySelector(
  ".card-back-maquina"
) as HTMLElement;
let carta_maquina = document.querySelector(".carta-maquina") as HTMLElement;
let cardJogador = document.querySelector(".card-jogador") as HTMLElement;
let cardMaquina = document.querySelector(".card-maquina") as HTMLElement;

let btnSortear = document.getElementById("btnSortear") as HTMLButtonElement;
let btnJogar = document.getElementById("btnJogar") as HTMLButtonElement;
let btnProximaRodada = document.getElementById(
  "btnProximaRodada"
) as HTMLButtonElement;

let htmlResultado: string;

let cartaMaquina: ICard;
let cartaJogador: ICard;
...
function atualizaQuantidadeDeCartas() {
  let divQuantidadeCartasJogador = document.querySelector(
    ".cartas-jogador"
  ) as HTMLDivElement;
  let divQuantidadeCartasMaquina = document.querySelector(
    ".cartas-maquina"
  ) as HTMLDivElement;
...
function atualizaPlacar() {
  let divPlacar = document.querySelector(".placar") as HTMLDivElement;
...
function exibeCartaJogador() {
  let nome = document.querySelector(".player") as HTMLImageElement;
  let imgCartaJogador = document.querySelector(
    ".img-carta-jogador"
  ) as HTMLImageElement;
  let time = document.querySelector(".time") as HTMLImageElement;
  let raca = document.querySelector(".raca") as HTMLImageElement;
  let pais = document.querySelector(".pais") as HTMLImageElement;
  ...
  let areaAtributos = document.querySelector(
    ".area-atributos"
...
function obtemAtributoSelecionado() {
  let radioAtributo = document.getElementsByName(
    "atributo"
...
function jogar() {
  ...
  let divResultado = document.getElementById("resultado") as HTMLDivElement;
...
function exibeCartaMaquina() {
  let nomeMaq = document.querySelector(".player-maq") as HTMLHeadingElement;
  let imgCartaMaquina = document.querySelector(
    ".img-carta-maquina"
  ) as HTMLImageElement;
  let timeMaq = document.querySelector(".time-maq") as HTMLImageElement;
  let racaMaq = document.querySelector(".raca-maq") as HTMLImageElement;
  let paisMaq = document.querySelector(".pais-maq") as HTMLImageElement;
  let iconMaq = document.querySelector(".icon-maq") as HTMLImageElement;
  ...
  let areaAtributosMaq = document.querySelector(
    ".area-atributos-maq"
  ) as HTMLFieldSetElement;
...
function proximaRodada() {
  ...
  btnJogar = document.querySelector(".button-jogar") as HTMLButtonElement;
